...
class Square(Attack):
    ...
    """
    def __init__(self, model,dataset_name,device,_targeted, norm='Linf', eps=None, n_queries=5000, n_restarts=1,
                 p_init=.8, loss='margin', resc_schedule=True,
                 seed=0, verbose=False):
        super().__init__("Square", model,dataset_name)
        self.norm = norm
    ...
    def perturb(self, x, y=None):
        ...
        for counter in range(self.n_restarts):
            ...
            if ind_to_fool.numel() != 0:
                ...
                output_curr = self.model(adv_curr1)
                if not self._targeted:
