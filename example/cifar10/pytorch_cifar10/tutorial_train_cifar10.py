...
import sys
import os
sys.path.append(os.path.join('/data/chenhai-fwxz/ares_ch/pytorch_ares'))
from attack_torch import FGSM
import argparse
...
trainset = torchvision.datasets.CIFAR10(
    root='/data/chenhai-fwxz/code/ares_ch/pytorch_ares/dataset_torch/CIFAR10', train=True, download=True, transform=transform_train)
trainloader = torch.utils.data.DataLoader(
    trainset, batch_size=128, shuffle=True, num_workers=2)

testset = torchvision.datasets.CIFAR10(
    root='/data/chenhai-fwxz/code/ares_ch/pytorch_ares/dataset_torch/CIFAR10', train=False, download=True, transform=transform_test)
...
def test(epoch):
    ...
    if args.mode == "cln":
        if clean_acc > best_acc:
            ...
            if not os.path.isdir('/data/chenhai-fwxz/ares_ch/pytorch_ares/checkpoint'):
                os.mkdir('checkpoint')
            torch.save(state, '/data/chenhai-fwxz/ares_ch/pytorch_ares/checkpoint/simpledla_ckpt.pth')
            best_acc = clean_acc
